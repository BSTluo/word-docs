...
|作用|语法格式|返回值|
|:--:|:--:|:--:|
|获取列表中随机一项的内容|(a~:`<列表名称>`:``<用户id>?`)|列表中随机一项内容|
...
|作用|语法|返回值|
|:--:|:--:|:--:|
|获取`成就列表`中随机一项的内容|(a~:成就列表)|成就A|
|从被at的人的背包内的`成就列表`中，获取随机一项内容|(a~:成就列表:that)|成就C|
...
|作用|语法格式|返回值|
|:--:|:--:|:--:|
|获取列表中某内容的序号|(ar:`<列表名称>`:`列表内容`:``<用户id>?`)|内容所在的序号|
...
|作用|语法|返回值|
|:--:|:--:|:--:|
|获取`成就列表`中`成就B`的序号|(ar:成就列表:成就B)|2|
|从被at的人的背包内的`成就列表`中，`成就B`的序号|(ar:成就列表:成就B:that)|2|
...
|将被at的人的背包内的`成就列表`中，设置`成就B`为`成就E`|(as:成就列表:2:成就E:that)|2|
...
|作用|语法格式|返回值|
|:--:|:--:|:--:|
|判断列表中第x个内容是否存在|(a?:`<列表名称>`:`序号`:`<用户id>?`)|有:1，无:0|
...
|作用|语法|返回值|
|:--:|:--:|:--:|
|获取第四个内容是否存在|(a?:成就列表:4)|0|
|获取第二个内容是否存在|(a?:成就列表:2)|1|
|判断被at的人的背包内的`成就列表`中，是否存在第二个内容|(a?:成就列表:2:that)|1|
